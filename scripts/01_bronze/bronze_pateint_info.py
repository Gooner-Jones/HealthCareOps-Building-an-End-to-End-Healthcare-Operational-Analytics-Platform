# Create a text widget for catalog name and retrieve its value
...
# ============================================================
# DIAGNOSES, WARDS, ADMISSION TYPES 
# ============================================================
DIAGNOSES = [
...
# ============================================================
# GENERATE RECORDS
# Note: 250,000 patients. If this runs slowly on Free Edition's
